...
<div id="main">
    ...
    <table>
        ...
        <c:if test="${empty sessionScope.cart.items}">
            <tr>
                <td colspan="5">
                    <a href="index.jsp"> 购物车是空的哦，快去加点商品吧！</a>
                </td>
            </tr>
        </c:if>
                ...
                <tr>
                    ...
                    <td>
                        <input class="updateCount" style="width: 60px;"
                               type="text" bookId="${item.value.id}"
    ...
    <c:if test="${not empty sessionScope.cart.items}">
        <div class="cart_info">
            ...
            <span class="cart_span"><a href="cartServlet?action=clear" id="clearToCart">清空购物车</a></span>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("input.updateCount").change(function () {
            ...
            if (confirm("你确定要将【" + $(this).parent().parent().find("td:first").text() + "】商品的数量修改为【" + count + "】吗？")) {
